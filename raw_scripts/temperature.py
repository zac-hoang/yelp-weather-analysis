...
# Đọc file CSV
df = pd.read_csv(r"E:\Download\Data_AE_Test\Data\Climate Data\temperature-degreef.csv")

# Kiểm tra dữ liệu đầu tiên

# Ghi vào bảng Postgres (tạo bảng mới hoặc ghi đè)
df.to_sql("all_temperature", engine, if_exists="replace", index=False)

print("✅ Done! Data temperature has been loaded into Postgres.")
